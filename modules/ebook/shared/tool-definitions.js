        ...
        definitions.push(
            {
                ...
                function: {
                    ...
                    description: [
                        ...
                        'Use for creating files, complete file rewrites, whole sections, whole chapters, or rewrites where most content is new.',
            ...
            },
            {
                ...
                function: {
                    ...
                    description: [
                        'Edit one existing current-book file by replacing original text fragments, replacing inclusive line ranges, or inserting text at line positions from a recent Read result.',
                        ...
                        properties: {
                            ...
                            edits: {
                                ...
                                items: {
                                    type: 'object',
                                    properties: {
                                        oldString: { type: 'string', description: 'Original text fragment to replace. Must match exactly, with common punctuation/long-whitespace tolerance. Do not use an empty oldString; use Write to create files.' },
                                        ...
                                        newString: { type: 'string', description: 'Replacement or inserted text.' },
