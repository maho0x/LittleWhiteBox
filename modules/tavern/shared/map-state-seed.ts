...
export function buildSeedMapHint(): string {
    return [
        ...
        'If the scene has a distinctive outer shape, draw that confirmed outline first with path or curve instead of flattening it into a plain box: caves, forest clearings, shorelines, ruins, alleys, broken rooms, and irregular yards should have recognizable silhouettes before internal zones and interactive elements are placed.',
